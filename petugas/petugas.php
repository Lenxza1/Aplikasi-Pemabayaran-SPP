          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="tambah_petugas.php">Tambah Data</a></li>
                </ol>
              </nav>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="" method="post">
                      ...
                      <a href="edit_petugas.php?id=<?php echo $row['id'];?>&level=<?php echo $row['level'];?>" class="btn btn-mini btn-success">
                        Update
                      </a>
                    </form>
                  </td>
