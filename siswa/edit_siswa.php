<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        $sql = "UPDATE siswa SET nis='$nis', nama='$nama', id_kelas='$idKelas', alamat='$alamat', no_telp='$noTelp', id_spp='$idSpp' WHERE id='$id'";
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" value="<?php echo $row["nis"] ?>" name="nis">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" value="<?php echo $row["id_kelas"] ?>" name="idKelas">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Alamat</label>
                        <input type="textarea" class="form-control" id="exampleInputName1" value="<?php echo $row["alamat"] ?>" name="alamat">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">No Telp</label>
                        <input type="text" class="form-control" id="exampleInputName1" value="<?php echo $row["no_telp"] ?>" name="noTelp">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">ID SPP</label>
                        <input type="text" class="form-control" id="exampleInputName1" value="<?php echo $row["id_spp"] ?>" name="idSPP">
                      </div>
                      <button type="submit" class="btn btn-primary mr-2" name="submit">Submit</button>
                      <a class="btn btn-light" href="siswa.php">Cancel</a>
                    </form>
                  </div>
                </div>
              </div>
