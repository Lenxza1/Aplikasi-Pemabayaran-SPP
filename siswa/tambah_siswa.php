<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        $sql = "insert into siswa (nis,nama,id_kelas,alamat,no_telp,id_spp) values ('$nis','$nama','$idKelas','$alamat','$noTelp','$idSpp')";
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Nis" name="nis">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="ID Kelas" name="idKelas">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Alamat</label>
                        <input type="textarea" class="form-control" id="exampleInputName1" placeholder="Alamat" name="alamat">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">No Telp</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="No Telp" name="noTelp">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">ID SPP</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="ID SPP" name="idSPP">
                      </div>
