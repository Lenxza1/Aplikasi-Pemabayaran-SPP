<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        $sql = "insert into pembayaran (id_petugas,id_siswa,tgl_bayar,bulan_bayar,tahun_bayar,id_spp,jumlah_bayar) values ('$idPetugas','$idSiswa','$tglBayar','$blnBayar','$thnBayar','$idSpp','$jmlBayar')";
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" min="1" max="31" class="form-control" id="exampleInputName1" value="1" name="tglBayar">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Bulan Bayar</label>
                        <input type="number" min="1" max="12" class="form-control" id="exampleInputName1" value="1" name="blnBayar">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Tahun Bayar</label>
                        <input type="number" min="1940" max="2099" class="form-control" id="exampleInputName1" value="2023" name="thnBayar">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" min="100000" class="form-control" id="exampleInputName1" name="jmlBayar">
                      </div>
