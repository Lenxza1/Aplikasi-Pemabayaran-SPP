          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="tambah_transaksi.php">Tambah Data</a></li>
                </ol>
              </nav>
             <?php } ?>
            </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="" method="post">
                      ...
                      <a href="edit_transaksi.php?id=<?php echo $row['id'];?>&idSiswa=<?php echo $row['id_siswa'];?>&idSpp=<?php echo $row['id_spp'] ?>" class="btn btn-mini btn-success">
                        Update
                      </a>
                    </form>
                  </td>
