<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        $sql = "update kelas set nama='$nama',kompetensi='$kompetensi' where id='$id'";
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" value="<?php echo $row["kompetensi"] ?>" name="kompetensi">
                      </div>
