<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        $sql = "update spp set tahun='$tahun',nominal='$nominal' where id='$id'";
    ...
    $sql = "select * from spp where id='$id'";
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" min="1900" max="2099" step="1" value="<?php echo $row["tahun"] ?>" name="tahun"/>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Nominal</label>
                        <input type="number" min="100000" class="form-control" id="exampleInputName1" value="<?php echo $row["nominal"] ?>" name="nominal">
                      </div>
