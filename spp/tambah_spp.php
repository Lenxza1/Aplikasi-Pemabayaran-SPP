                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" min="1900" max="2099" step="1" value="2016" name="tahun"/>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Nominal</label>
                        <input type="number" min="100000" class="form-control" id="exampleInputName1" value="500000" name="nominal">
                      </div>
                      <button type="submit" class="btn btn-primary mr-2" name="submit">Submit</button>
                      <a class="btn btn-light" href="spp.php">Cancel</a>
                    </form>
                  </div>
                </div>
              </div>
